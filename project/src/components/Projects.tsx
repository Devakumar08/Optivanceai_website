...
const projects = [
  ...
  {
    title: 'Voice AI Bot',
    description: 'A fun and interactive voice AI assistant that engages users with humor and personality, inspired by The Useless Funny Assistant.',
    icon: <Mic size={24} />,
    iconBg: 'bg-secondary-500/20',
    iconColor: 'text-secondary-400',
    techStack: ['Custom Voice AI', 'React', 'Web Speech API'],
