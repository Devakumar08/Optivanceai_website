      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project) => {
            ...
            return (
              <div key={project.title} className="card hover:shadow-lg hover:shadow-secondary-500/5 overflow-hidden group">
                ...
                <div className="mt-6 bg-dark-700 h-48 rounded-lg overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center">
                    ...
                    {/* Optional: Replace with an image tag like <img src="..." alt="..." /> */}
                  </div>
                </div>
              </div>
            );
